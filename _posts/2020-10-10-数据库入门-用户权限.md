...
- 2，在 不同版本的数据库中，创建用户的操作不同
  ...
  - 8.0之前的版本
    ...
    --若出现ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ，检查单双引号
    ```
